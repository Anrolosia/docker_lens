...
class HaDockerLensPanel extends HTMLElement {
  ...
  _mount() {
    ...
    this.style.cssText =
      "display:flex;flex-direction:column;height:100%;background:var(--primary-background-color);";
    ...
    toolbar.style.cssText =
      "display:flex;align-items:center;height:64px;padding:0 16px;gap:8px;";
